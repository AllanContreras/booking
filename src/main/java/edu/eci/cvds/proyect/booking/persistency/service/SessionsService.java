...
public interface SessionsService {
     ...
     * @return UserModel The user associated with the session, or null if the
     *         session is invalid.
     */

    User getUserFromSession(String sessionId) throws SessionException;
    ...
    String createSessionCookie(User user) throws SessionException;
     ...
     * 
     * @return boolean True if the session was successfully renewed, false if the
     *         session is invalid.
     * 
     */
